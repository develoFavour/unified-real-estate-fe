      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-3">
          ...
          <div>
            ...
            <p className="text-gray-500 font-light mt-2">Issue tenant invoices and monitor rent collection.</p>
          </div>
        </div>
      ...
      <div className="bg-white/[0.02] border border-white/5 rounded-[2rem] p-6 md:p-8 space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Create rent, service charge, legal fee, caution deposit, agency fee, or custom invoices.</p>
          </div>
